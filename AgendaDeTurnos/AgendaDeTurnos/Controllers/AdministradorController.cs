...
namespace AgendaDeTurnos.Controllers
{
    ...
    public class AdministradorController : Controller
    {
        ...
        public AdministradorController(AgendaDeTurnosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Dni,Email,Telefono,Direccion,FechaAlta,Password")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nombre,Apellido,Dni,Email,Telefono,Direccion,FechaAlta,Password")] Administrador administrador)
        {
