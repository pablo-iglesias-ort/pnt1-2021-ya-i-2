		...
		public static void Inicializar(AgendaDeTurnosContext context)
		{
			...
			if (!context.Profesional.Any())
			{
				...
				var turno = new Turno
				{
					...
					Confirmado = true,
					Atendido = false,
					Fecha = new DateTime(2021, 11, 20, 12, 00, 0),
					FechaAlta = DateTime.Now,
				...
				var turno2 = new Turno
				{
					...
					Confirmado = true,
					Atendido = false,
					Fecha = new DateTime(2021, 11, 20, 14, 00, 0),
					FechaAlta = DateTime.Now,
					Paciente = null,
					PacienteId = null,
					Profesional = usuarioProfesional,
				...
				var turno3 = new Turno
				{
					...
					Confirmado = true,
					Atendido = false,
					Fecha = new DateTime(2021, 11, 20, 15, 00, 0),
					FechaAlta = DateTime.Now,
					Paciente = null,
					PacienteId = null,
					Profesional = usuarioProfesional,
				...
				var turno4 = new Turno
				{
					...
					Confirmado = false,
					Atendido = false,
					Fecha = new DateTime(2021, 11, 20, 16, 00, 0),
					FechaAlta = DateTime.Now,
					Paciente = null,
					PacienteId = null,
					Profesional = usuarioProfesional,
				...
				var turno6 = new Turno
				{
					...
					Confirmado = true,
					Atendido = false,
					Fecha = new DateTime(2021, 11, 20, 13, 00, 0),
					FechaAlta = DateTime.Now,
					Paciente = null,
					PacienteId = null,
					Profesional = usuarioProfesional2,
